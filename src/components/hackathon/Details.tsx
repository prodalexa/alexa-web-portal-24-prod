      ...
      <div className="container mx-auto md:px-20 md:pt-24">
        <div className="grid grid-cols-12 gap-6">
          <div className="col-span-12 md:col-span-5 md:col-start-1 flex flex-col gap-8">
            <Grid name="Venue" line1="Sir J.C. Bose" line2="Tech Park (12th floor)" className="order-1" />
            <Grid name="Team Size" line1="2-4" line2="Members" className="order-3" />
            <Grid name="Prize Pool" line1="To be announced" line2="" className="order-5" />
          </div>
          
          <div className="col-span-12 md:col-span-5 md:col-start-8 flex flex-col gap-8 md:pt-40">
            <Grid name="Duration" line1="24" line2="Hours" className="order-2" />
            <Grid name="Registration Cost" line1="₹150/- per team" line2="" className="order-4" />
          </div>
        </div>
      </div>
    </section>
