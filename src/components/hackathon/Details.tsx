...
const Details = () => {
  return (
    <section id="details" className="py-20 md:py-8 relative overflow-hidden">
      <div className="flex items-start justify-start md:items-center mt-4 md:mb-0">
        <svg
      ...
      <div className="container mx-auto px-20 pt-24">
        <div className="grid grid-cols-12 gap-6">
          <div className="col-span-12 md:col-span-5 md:col-start-1 flex flex-col gap-8">
            <Grid name="Venue" line1="Sir J.C. Bose" line2="Tech Park (12th floor)" />
            <Grid name="Team Size" line1="2-4" line2="Members" />
            <Grid name="Prize Pool" line1="To be announced" line2="" />
          </div>
          
          <div className="col-span-12 md:col-span-5 md:col-start-8 flex flex-col gap-8 pt-40">
            <Grid name="Duration" line1="24" line2="Hours" />
            <Grid name="Registration Cost" line1="₹150/- per team" line2="" />
          </div>
        </div>
      </div>
    </section>
