  ...
  return (
    <div className="relative w-screen md:min-h-screen flex flex-col overflow-hidden -mt-72 md:mt-0">
      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto px-4 md:px-8">
        <form id="registration-form" className="space-y-8 font-monsterrat">
              ...
              <div>
                ...
                <div className="flex">
                  ...
                  <input
                    ...
                    className="w-full bg-gaming_form_bg border border-white/30  rounded-r-lg px-4 py-3 text-white placeholder-white/50 focus:outline-none focus:border-white"
                  />
                </div>
              </div>
              <div>
          ...
          <div className="w-full flex justify-center pt-8">
            <button
              type="submit"
              className="bg-gradient-to-r from-[#460156] to-[#9902BC] text-white font-bold font-monsterrat py-4 px-12 text-lg rounded-xl hover:bg-opacity-90 transition-opacity border-4 border-white inline-flex items-center"
            >
