...
const HeroSection = (props: Props) => {
  return (
    ...
    >
      ...
      <div className="flex flex-col justify-center items-center md:items-start text-center md:text-left md:w-[60%] order-2 md:order-1 md:translate-x-20">
      ...
      <div className="relative w-80 h-80 md:w-[40%] md:h-auto order-1 md:order-2">
        <Image
