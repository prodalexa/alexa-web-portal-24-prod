...
function ContactUs({}: Props) {
  ...
  return (
    <div className="flex flex-col justify-center items-center pb-20">
      ...
      />
      <div className="grid grid-flow-row grid-cols-2 place-content-center md:flex md:flex-row items-center justify-center my-10 w-full lg:px-20">
        ...
        <Image
          ...
          width={850}
          alt="Hero Logo"
          className="hidden md:flex md:h-[300px] md:w-[300px] lg:h-[400px] lg:w-[400px] xl:h-[500px] xl:w-[500px]"
        />
        {contactList.map((item, key) => (
          <AnimatedTooltip key={`${platform} + ${key}`} item={item} />
        ))}
      ...
      <div className="w-full flex text-white justify-center font-bold text-5xl md:text-7xl items-center">
        ...
        <span className="bg-gradient-to-r from-[#31B553] to-[#0AA294] bg-clip-text text-transparent ml-2">.</span>
      </div>
