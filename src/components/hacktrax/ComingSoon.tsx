        ...
        <div className="grid grid-cols-4 gap-2 sm:gap-4 md:gap-6 w-full max-w-lg mx-auto">
            {timeUnits.map((unit) => (
                <div key={unit.label} className="flex flex-col items-center">
                    <div className="bg-hack_orange border border-white/30 rounded-lg w-14 h-14 sm:w-16 sm:h-16 md:w-20 md:h-20 flex items-center justify-center text-white text-base sm:text-xl md:text-2xl font-bold">
                        {unit.value}
                    </div>
...
const ComingSoon = () => {
    ...
    return (
        <div id="register" className="relative w-screen md:min-h-screen flex flex-col overflow-hidden mt-8 md:mt-0">
